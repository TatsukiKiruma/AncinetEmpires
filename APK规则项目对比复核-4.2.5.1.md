...
- pending 存在时只生成该单位动作，且不生成招募。2026-06-30 用户实机确认：空城堡招募 pending 仍可结束回合/投降；指挥官站城堡产生的堆叠招募 pending 不能结束回合或投降。
