...
1. 校准 skirmish 高频与低可信 APK tile 语义
   ...
   - 低可信 tile 实测目标已可由 `getApkSkirmishTerrainVerificationTargets()` 直接导出，默认只列官方 skirmish 中实际出现的 `t30/t31` 目标，并附带精确坐标、APK owner code 和项目当前规则语义。
