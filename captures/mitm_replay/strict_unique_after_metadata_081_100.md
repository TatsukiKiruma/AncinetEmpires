...
| 分类 | 数量 | 首个失败 |
| --- | ---: | --- |
| strict 目的格被项目状态占用 (`strict_move_destination_occupied`) | 1 | game_get_20260704_132339_097.bin#3008 OCCUPY move:u_267:5,2 |
...
- 地图：21x21，scenario=SD，campaignLike=false，玩家=[0,1,2,3,4,5]，初始单位=12，推荐金币=300
...
- 地图：9x11，scenario=SO，campaignLike=false，玩家=[1,3]，初始单位=2，推荐金币=250
...
- 地图：25x25，scenario=SD，campaignLike=false，玩家=[0,1,2,3,4,5]，初始单位=6，推荐金币=-1
