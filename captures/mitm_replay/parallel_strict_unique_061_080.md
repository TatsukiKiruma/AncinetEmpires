...
- 项目动作：`move:u_13:4,6`
- 失败诊断：actor=u_13/soldier/P3@(3,3) hp=100/100 lv=0 exp=0 range=1-1 status=none；target=-；move占位=-；sourceTargetDist=-；moveTargetDist=-
...
- 项目动作：`move:u_11:10,5`
- 失败诊断：actor=u_11/soldier/P1@(11,7) hp=100/100 lv=0 exp=0 range=1-1 status=none；target=apk_remote_u1/ghost/P4@(10,4) hp=100/100 lv=0 exp=0 range=1-1 status=none；move占位=-；sourceTargetDist=4；moveTargetDist=1
- 引擎信息：非法动作：当前玩家无法执行该动作
