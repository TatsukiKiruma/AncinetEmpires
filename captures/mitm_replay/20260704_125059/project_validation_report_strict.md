...
| game_get_20260704_125247_003.bin | cfd8d0fadd57 | 11x19, P[0,1,2,3,5] | 1370 | 失败 | 38/1370 | APK 招募记录缺少部署坐标，存在 22 个可部署动作 |
...
- 校验进度：已执行 38 / 1370 条 APK 记录，展开项目动作 59 个
- 终局状态：turn=2，currentPlayer=3，winner=-
- 首个问题：APK 招募记录缺少部署坐标，存在 22 个可部署动作
- APK 记录：event=NONE，source=(1,15)，move=-，target=-，recruitId=17
- 问题位置：record=38, turn=2, currentPlayer=3, legalActions=346
- 项目动作：`-`
- 引擎信息：-
