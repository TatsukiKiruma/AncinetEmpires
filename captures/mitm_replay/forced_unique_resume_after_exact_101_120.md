...
| game_get_20260704_132655_110.bin | 2357e2bd64ef | 21x21, P[0,1,2,3,4,5] | 11 | 通过 | 11/11 | - |
...
- 地图：21x21，玩家=[0,1,2,3,4,5]，初始单位=6，推荐金币=300
- 项目开局：currentPlayer=5，activeTeams=[0,1,2,3,4,5]，initialGold=500，unitLimit=100，levelCap=9
- 本局价格覆盖：soldier=150, archer=250, water_elemental=300, witch=400, elf=500, wolf=600, golem=600, catapult=800, dragon=1000, commander=400, paladin=400, berserker=500, ghost=200, dark_mage=300, wolf_archer=800, ice_elemental=600, slime=250, mermaid=200, druid=600
- 动作：11 条，remaining=0，事件=ATTACK=9, NEXT_TURN=1, SURRENDER=1
- 包诊断：topFields=[g]，topRemaining=0，onlyG=true，replayEOF=true，currentStep=-1，replaySplitIndex=-1，room=PRIVATE/CLOSED
- 校验进度：已执行 11 / 11 条 APK 记录，展开项目动作 2 个
