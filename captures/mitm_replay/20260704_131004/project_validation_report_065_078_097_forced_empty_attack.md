...
| --- | --- | --- | ---: | --- | --- | --- |
| game_get_20260704_132008_065.bin | 1269141a5313 | 13x13, P[4,1,0,5,2,3] | 1182 | 失败 | 291/1182 | 找不到来源单位: (6, 10) |
...
- 校验进度：已执行 291 / 1182 条 APK 记录，展开项目动作 476 个
- 终局状态：turn=6，currentPlayer=0，winner=-
- 首个问题：找不到来源单位: (6, 10)
- APK 记录：event=ATTACK，source=(6,10)，move=(6,10)，target=(3,10)，recruitId=-1
- 问题位置：record=291, turn=6, currentPlayer=0, legalActions=118
- 项目动作：`-`
- 失败诊断：actor=-；target=u_33/soldier/P2@(3,10) hp=100/100 lv=1 exp=120 range=1-1 status=none；move占位=-；sourceTargetDist=3；moveTargetDist=3
- 引擎信息：-
