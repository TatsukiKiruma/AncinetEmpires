...
| --- | --- | --- | ---: | --- | --- | --- |
| game_get_20260704_132339_097.bin | 5619d6a85c7d | 25x25, P[0,1,2,3,4,5] | 3221 | 失败 | 241/3221 | 找不到攻击目标单位: (3, 10) |
...
- 校验进度：已执行 241 / 3221 条 APK 记录，展开项目动作 400 个
- 终局状态：turn=5，currentPlayer=0，winner=-
- 首个问题：找不到攻击目标单位: (3, 10)
- APK 记录：event=ATTACK，source=(3,14)，move=(3,12)，target=(3,10)，recruitId=-1
- 问题位置：record=241, turn=5, currentPlayer=0, legalActions=115
- 项目动作：`-`
- 失败诊断：actor=u_7/druid/P0@(3,14) hp=80/100 lv=0 exp=80 range=1-2 status=none；target=-；move占位=-；sourceTargetDist=4；moveTargetDist=2
- 引擎信息：-
