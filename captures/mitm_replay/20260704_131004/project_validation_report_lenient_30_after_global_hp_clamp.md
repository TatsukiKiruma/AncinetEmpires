...
| game_get_20260704_131048_002.bin | 31b6ac6e56fb | 21x21, P[0,1,2,3,4,5] | 6932 | 失败 | 457/6932 | 非法动作：当前玩家无法执行该动作 |
| game_get_20260704_131052_003.bin | bf67e73547fc | 15x12, P[0,1,2,3] | 1049 | 失败 | 825/1049 | 非法动作：当前玩家无法执行该动作 |
| game_get_20260704_131100_004.bin | 8731fe932b23 | 18x19, P[0,1,2,3,4,5] | 1839 | 失败 | 769/1839 | 非法动作：当前玩家无法执行该动作 |
| game_get_20260704_131113_005.bin | 8917e542b931 | 17x12, P[0,2,3,4] | 928 | 通过 | 928/928 | - |
| game_get_20260704_131118_006.bin | 7a0dda589803 | 21x13, P[0,1,2,3,4,5] | 1622 | 失败 | 774/1622 | 非法动作：当前玩家无法执行该动作 |
| game_get_20260704_131123_007.bin | 205dd6b03de1 | 17x12, P[0,2,3,4] | 52 | 通过 | 52/52 | - |
| game_get_20260704_131130_008.bin | a706d70a4e6e | 21x21, P[0,1,2,3,4,5] | 1065 | 失败 | 816/1065 | 找不到来源单位: (2, 2) |
| game_get_20260704_131132_009.bin | 55d597d21443 | 21x21, P[0,1,2,3,4,5] | 1652 | 失败 | 481/1652 | 非法动作：当前玩家无法执行该动作 |
| game_get_20260704_131135_010.bin | c1e6247384bb | 17x12, P[0,2,3,4] | 785 | 通过 | 785/785 | - |
| game_get_20260704_131141_011.bin | e99b550fbb09 | 21x21, P[0,1,2,3,4,5] | 1297 | 失败 | 389/1297 | 非法动作：当前玩家无法执行该动作 |
...
| game_get_20260704_131151_014.bin | c3358fb41a8d | 21x13, P[0,1,2,3,4,5] | 502 | 失败 | 283/502 | 非法动作：当前玩家无法执行该动作 |
| game_get_20260704_131157_015.bin | 235b2c26b3f4 | 12x12, P[0,1,2,3,4,5] | 232 | 通过 | 232/232 | - |
| game_get_20260704_131211_016.bin | a0aa3f4c9007 | 21x21, P[0,1,2,3,4,5] | 2983 | 失败 | 686/2983 | 非法动作：当前玩家无法执行该动作 |
| game_get_20260704_131212_017.bin | a2e8d7cc8d35 | 18x19, P[0,1,2,3,4,5] | 1 | 通过 | 1/1 | - |
| game_get_20260704_131221_018.bin | 022a8ed5f05c | 21x13, P[0,1,2,3,4,5] | 2154 | 失败 | 1501/2154 | 非法动作：当前玩家无法执行该动作 |
| game_get_20260704_131229_019.bin | 1fa374fe09d3 | 21x21, P[0,1,2,3,4,5] | 4868 | 失败 | 392/4868 | 非法动作：当前玩家无法执行该动作 |
| game_get_20260704_131235_020.bin | a0f4b5dde4a1 | 21x13, P[0,1,2,3,4,5] | 1728 | 失败 | 558/1728 | 找不到召唤目标墓碑: (16, 5) |
| game_get_20260704_131256_021.bin | cfd8d0fadd57 | 11x19, P[0,1,2,3,5] | 1370 | 失败 | 347/1370 | 非法动作：当前玩家无法执行该动作 |
| game_get_20260704_131304_022.bin | ea7eaf070647 | 17x12, P[0,2,3,4] | 881 | 通过 | 881/881 | - |
| game_get_20260704_131309_023.bin | c72987ab3319 | 19x20, P[0,1,2,3,4,5] | 4952 | 失败 | 814/4952 | 找不到来源单位: (3, 19) |
...
| game_get_20260704_131321_026.bin | ea66acda66a4 | 21x13, P[0,1,2,3,4,5] | 842 | 失败 | 638/842 | 非法动作：当前玩家无法执行该动作 |
...
| game_get_20260704_131337_029.bin | 42f2ac258b2d | 21x13, P[0,1,2,3,4,5] | 2305 | 失败 | 840/2305 | 非法动作：当前玩家无法执行该动作 |
...
- 校验进度：已执行 457 / 6932 条 APK 记录，展开项目动作 795 个
- 终局状态：turn=7，currentPlayer=5，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=STANDBY，source=(11,17)，move=(15,17)，target=-，recruitId=-1
- 问题位置：record=457, turn=7, currentPlayer=5, legalActions=238
- 项目动作：`move:apk_remote_u2:15,17`
...
- 校验进度：已执行 825 / 1049 条 APK 记录，展开项目动作 1255 个
- 终局状态：turn=26，currentPlayer=2，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(11,4)，move=(10,5)，target=(8,5)，recruitId=-1
- 问题位置：record=825, turn=26, currentPlayer=2, legalActions=42
- 项目动作：`move:u_44:10,5`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 769 / 1839 条 APK 记录，展开项目动作 1294 个
- 终局状态：turn=12，currentPlayer=0，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=HEAL，source=(5,18)，move=(4,17)，target=(5,17)，recruitId=-1
- 问题位置：record=769, turn=12, currentPlayer=0, legalActions=13
- 项目动作：`move:u_74:4,17`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 774 / 1622 条 APK 记录，展开项目动作 1210 个
- 终局状态：turn=11，currentPlayer=4，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=SUPPORT，source=(0,5)，move=(1,6)，target=(2,7)，recruitId=-1
- 问题位置：record=774, turn=11, currentPlayer=4, legalActions=131
- 项目动作：`move:u_105:1,6`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 816 / 1065 条 APK 记录，展开项目动作 1398 个
- 终局状态：turn=11，currentPlayer=1，winner=-
- 首个问题：找不到来源单位: (2, 2)
- APK 记录：event=ATTACK，source=(2,2)，move=(2,2)，target=(4,2)，recruitId=-1
- 问题位置：record=816, turn=11, currentPlayer=1, legalActions=36
- 项目动作：`-`
- 引擎信息：-
...
- 校验进度：已执行 481 / 1652 条 APK 记录，展开项目动作 843 个
- 终局状态：turn=8，currentPlayer=2，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=STANDBY，source=(4,3)，move=(2,3)，target=-，recruitId=-1
- 问题位置：record=481, turn=8, currentPlayer=2, legalActions=254
- 项目动作：`move:u_54:2,3`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 389 / 1297 条 APK 记录，展开项目动作 676 个
- 终局状态：turn=7，currentPlayer=2，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(8,3)，move=(4,3)，target=(2,2)，recruitId=-1
- 问题位置：record=389, turn=7, currentPlayer=2, legalActions=141
- 项目动作：`move:u_25:4,3`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 283 / 502 条 APK 记录，展开项目动作 448 个
- 终局状态：turn=6，currentPlayer=0，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=STANDBY，source=(2,6)，move=(2,4)，target=-，recruitId=-1
- 问题位置：record=283, turn=6, currentPlayer=0, legalActions=89
- 项目动作：`move:u_30:2,4`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 686 / 2983 条 APK 记录，展开项目动作 1194 个
- 终局状态：turn=10，currentPlayer=0，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(19,19)，move=(17,18)，target=(16,18)，recruitId=-1
- 问题位置：record=686, turn=10, currentPlayer=0, legalActions=33
- 项目动作：`move:u_22:17,18`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 1501 / 2154 条 APK 记录，展开项目动作 2376 个
- 终局状态：turn=18，currentPlayer=0，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(3,10)，move=(3,7)，target=(1,7)，recruitId=-1
- 问题位置：record=1501, turn=18, currentPlayer=0, legalActions=21
- 项目动作：`move:u_145:3,7`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 392 / 4868 条 APK 记录，展开项目动作 675 个
- 终局状态：turn=7，currentPlayer=2，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=STANDBY，source=(3,6)，move=(3,5)，target=-，recruitId=-1
- 问题位置：record=392, turn=7, currentPlayer=2, legalActions=249
- 项目动作：`move:u_9:3,5`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 558 / 1728 条 APK 记录，展开项目动作 885 个
- 终局状态：turn=9，currentPlayer=1，winner=-
- 首个问题：找不到召唤目标墓碑: (16, 5)
- APK 记录：event=SUMMON，source=(14,7)，move=(16,6)，target=(16,5)，recruitId=-1
- 问题位置：record=558, turn=9, currentPlayer=1, legalActions=39
- 项目动作：`-`
- 引擎信息：-
...
- 校验进度：已执行 347 / 1370 条 APK 记录，展开项目动作 543 个
- 终局状态：turn=11，currentPlayer=2，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(0,10)，move=(0,12)，target=(0,13)，recruitId=-1
- 问题位置：record=347, turn=11, currentPlayer=2, legalActions=85
- 项目动作：`move:u_9:0,12`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 814 / 4952 条 APK 记录，展开项目动作 1326 个
- 终局状态：turn=10，currentPlayer=0，winner=-
- 首个问题：找不到来源单位: (3, 19)
- APK 记录：event=SUPPORT，source=(3,19)，move=(3,19)，target=(3,18)，recruitId=-1
- 问题位置：record=814, turn=10, currentPlayer=0, legalActions=11
- 项目动作：`-`
- 引擎信息：-
...
- 校验进度：已执行 638 / 842 条 APK 记录，展开项目动作 1027 个
- 终局状态：turn=10，currentPlayer=0，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(2,1)，move=(1,3)，target=(1,4)，recruitId=-1
- 问题位置：record=638, turn=10, currentPlayer=0, legalActions=120
- 项目动作：`move:u_30:1,3`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 840 / 2305 条 APK 记录，展开项目动作 1327 个
- 终局状态：turn=12，currentPlayer=0，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(2,3)，move=(2,4)，target=(2,6)，recruitId=-1
- 问题位置：record=840, turn=12, currentPlayer=0, legalActions=195
- 项目动作：`move:u_93:2,4`
- 引擎信息：非法动作：当前玩家无法执行该动作
