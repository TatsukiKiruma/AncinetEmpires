...
- 失败诊断：actor=u_13/soldier/P1@(9,8) hp=100/100 lv=0 exp=0 range=1-1 status=none；target=apk_remote_u2/ghost/P3@(7,7) hp=100/100 lv=0 exp=0 range=1-1 status=none；move占位=u_13/soldier/P1@(9,8) hp=100/100 lv=0 exp=0 range=1-1 status=none；sourceTargetDist=4；moveTargetDist=3
