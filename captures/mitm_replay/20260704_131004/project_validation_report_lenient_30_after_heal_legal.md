...
| game_get_20260704_131048_002.bin | 31b6ac6e56fb | 21x21, P[0,1,2,3,4,5] | 6932 | 失败 | 1090/6932 | 找不到来源单位: (19, 17) |
...
| game_get_20260704_131221_018.bin | 022a8ed5f05c | 21x13, P[0,1,2,3,4,5] | 2154 | 失败 | 2003/2154 | 非法动作：当前玩家无法执行该动作 |
| game_get_20260704_131229_019.bin | 1fa374fe09d3 | 21x21, P[0,1,2,3,4,5] | 4868 | 失败 | 1533/4868 | 找不到来源单位: (1, 4) |
...
| game_get_20260704_131309_023.bin | c72987ab3319 | 19x20, P[0,1,2,3,4,5] | 4952 | 失败 | 534/4952 | 非法动作：当前玩家无法执行该动作 |
...
| game_get_20260704_131337_029.bin | 42f2ac258b2d | 21x13, P[0,1,2,3,4,5] | 2305 | 失败 | 1202/2305 | 非法动作：当前玩家无法执行该动作 |
...
- 校验进度：已执行 1090 / 6932 条 APK 记录，展开项目动作 1785 个
- 终局状态：turn=13，currentPlayer=3，winner=-
- 首个问题：找不到来源单位: (19, 17)
- APK 记录：event=STANDBY，source=(19,17)，move=(19,17)，target=-，recruitId=-1
- 问题位置：record=1090, turn=13, currentPlayer=3, legalActions=229
- 项目动作：`-`
- 引擎信息：-
...
- 校验进度：已执行 2003 / 2154 条 APK 记录，展开项目动作 3169 个
- 终局状态：turn=22，currentPlayer=5，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=OCCUPY，source=(12,4)，move=(8,3)，target=-，recruitId=-1
- 问题位置：record=2003, turn=22, currentPlayer=5, legalActions=445
- 项目动作：`move:apk_remote_u1:8,3`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 1533 / 4868 条 APK 记录，展开项目动作 2493 个
- 终局状态：turn=16，currentPlayer=5，winner=-
- 首个问题：找不到来源单位: (1, 4)
- APK 记录：event=ATTACK，source=(1,4)，move=(0,4)，target=(0,2)，recruitId=-1
- 问题位置：record=1533, turn=16, currentPlayer=5, legalActions=302
- 项目动作：`-`
- 引擎信息：-
...
- 校验进度：已执行 534 / 4952 条 APK 记录，展开项目动作 897 个
- 终局状态：turn=7，currentPlayer=4，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=HEAL，source=(14,9)，move=(16,9)，target=(15,9)，recruitId=-1
- 问题位置：record=534, turn=7, currentPlayer=4, legalActions=213
- 项目动作：`heal:u_81:u_76`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 1202 / 2305 条 APK 记录，展开项目动作 1879 个
- 终局状态：turn=15，currentPlayer=1，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(16,8)，move=(17,6)，target=(19,6)，recruitId=-1
- 问题位置：record=1202, turn=15, currentPlayer=1, legalActions=187
- 项目动作：`move:u_126:17,6`
- 引擎信息：非法动作：当前玩家无法执行该动作
