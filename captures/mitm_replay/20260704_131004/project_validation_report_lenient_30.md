...
| game_get_20260704_131118_006.bin | 7a0dda589803 | 21x13, P[0,1,2,3,4,5] | 1622 | 失败 | 427/1622 | 非法动作：当前玩家无法执行该动作 |
...
| game_get_20260704_131221_018.bin | 022a8ed5f05c | 21x13, P[0,1,2,3,4,5] | 2154 | 失败 | 1017/2154 | 非法动作：当前玩家无法执行该动作 |
...
| game_get_20260704_131321_026.bin | ea66acda66a4 | 21x13, P[0,1,2,3,4,5] | 842 | 失败 | 441/842 | 找不到召唤目标墓碑: (18, 6) |
...
- 校验进度：已执行 427 / 1622 条 APK 记录，展开项目动作 679 个
- 终局状态：turn=7，currentPlayer=5，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(20,6)，move=(17,6)，target=(17,5)，recruitId=-1
- 问题位置：record=427, turn=7, currentPlayer=5, legalActions=29
- 项目动作：`move:u_78:17,6`
...
- 校验进度：已执行 1017 / 2154 条 APK 记录，展开项目动作 1616 个
- 终局状态：turn=13，currentPlayer=5，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(18,7)，move=(17,6)，target=(16,6)，recruitId=-1
- 问题位置：record=1017, turn=13, currentPlayer=5, legalActions=84
- 项目动作：`move:u_51:17,6`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 441 / 842 条 APK 记录，展开项目动作 706 个
- 终局状态：turn=7，currentPlayer=5，winner=-
- 首个问题：找不到召唤目标墓碑: (18, 6)
- APK 记录：event=SUMMON，source=(20,9)，move=(20,6)，target=(18,6)，recruitId=-1
- 问题位置：record=441, turn=7, currentPlayer=5, legalActions=20
- 项目动作：`-`
- 引擎信息：-
