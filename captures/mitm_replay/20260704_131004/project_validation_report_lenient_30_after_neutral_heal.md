...
| game_get_20260704_131309_023.bin | c72987ab3319 | 19x20, P[0,1,2,3,4,5] | 4952 | 失败 | 1856/4952 | 非法动作：当前玩家无法执行该动作 |
...
| game_get_20260704_131337_029.bin | 42f2ac258b2d | 21x13, P[0,1,2,3,4,5] | 2305 | 失败 | 2242/2305 | 非法动作：当前玩家无法执行该动作 |
...
- 校验进度：已执行 1856 / 4952 条 APK 记录，展开项目动作 2930 个
- 终局状态：turn=17，currentPlayer=2，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(9,19)，move=(6,18)，target=(5,19)，recruitId=-1
- 问题位置：record=1856, turn=17, currentPlayer=2, legalActions=158
- 项目动作：`move:u_129:6,18`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 2242 / 2305 条 APK 记录，展开项目动作 3477 个
- 终局状态：turn=23，currentPlayer=5，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(16,5)，move=(13,6)，target=(13,7)，recruitId=-1
- 问题位置：record=2242, turn=23, currentPlayer=5, legalActions=124
- 项目动作：`move:u_59:13,6`
- 引擎信息：非法动作：当前玩家无法执行该动作
