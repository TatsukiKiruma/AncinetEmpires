...
| game_get_20260704_131048_002.bin | 31b6ac6e56fb | 21x21, P[0,1,2,3,4,5] | 6932 | 失败 | 919/6932 | 非法动作：当前玩家无法执行该动作 |
...
- 校验进度：已执行 919 / 6932 条 APK 记录，展开项目动作 1525 个
- 终局状态：turn=12，currentPlayer=0，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(18,19)，move=(17,18)，target=(16,19)，recruitId=-1
- 问题位置：record=919, turn=12, currentPlayer=0, legalActions=24
- 项目动作：`post_attack_move:u_22:18,19`
