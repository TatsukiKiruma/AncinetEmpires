...
| --- | --- | --- | ---: | --- | --- | --- |
| game_get_20260704_132339_097.bin | 5619d6a85c7d | 25x25, P[0,1,2,3,4,5] | 3221 | 失败 | 2115/3221 | 找不到治疗目标单位: (7, 10) |
...
- 校验进度：已执行 2115 / 3221 条 APK 记录，展开项目动作 3627 个
- 终局状态：turn=25，currentPlayer=0，winner=-
- 首个问题：找不到治疗目标单位: (7, 10)
- APK 记录：event=HEAL，source=(6,12)，move=(7,11)，target=(7,10)，recruitId=-1
- 问题位置：record=2115, turn=25, currentPlayer=0, legalActions=363
- 项目动作：`-`
- 失败诊断：actor=u_256/paladin/P0@(6,12) hp=100/100 lv=0 exp=30 range=1-1 status=inspired:0；target=-；move占位=-；sourceTargetDist=3；moveTargetDist=1
- 引擎信息：-
