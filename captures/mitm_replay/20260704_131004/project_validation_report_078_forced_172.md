...
| --- | --- | --- | ---: | --- | --- | --- |
| game_get_20260704_132050_078.bin | 72d58b04ba9f | 13x13, P[4,1,0,5,2,3] | 11 | 失败 | 0/11 | 找不到来源单位: (8, 0) |
...
- 项目开局：currentPlayer=4，activeTeams=[0,1,2,3,4,5]，initialGold=250，unitLimit=100，levelCap=9
...
- 动作：11 条，remaining=0，事件=ATTACK=2, NEXT_TURN=1, NONE=2, STANDBY=4, SURRENDER=2
- 包诊断：topFields=[g]，topRemaining=0，onlyG=true，replayEOF=true，currentStep=-1，replaySplitIndex=-1，room=PUBLIC/CLOSED
- 校验进度：已执行 0 / 11 条 APK 记录，展开项目动作 0 个
- 终局状态：turn=1，currentPlayer=4，winner=-
- 首个问题：找不到来源单位: (8, 0)
- APK 记录：event=STANDBY，source=(8,0)，move=(8,2)，target=-，recruitId=-1
- 问题位置：record=0, turn=1, currentPlayer=4, legalActions=58
- 项目动作：`-`
- 失败诊断：actor=-；target=-；move占位=-；sourceTargetDist=-；moveTargetDist=-
- 引擎信息：-
