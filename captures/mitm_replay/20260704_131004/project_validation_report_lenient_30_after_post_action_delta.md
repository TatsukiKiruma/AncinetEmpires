...
| game_get_20260704_131229_019.bin | 1fa374fe09d3 | 21x21, P[0,1,2,3,4,5] | 4868 | 失败 | 1843/4868 | 非法动作：当前玩家无法执行该动作 |
...
| game_get_20260704_131337_029.bin | 42f2ac258b2d | 21x13, P[0,1,2,3,4,5] | 2305 | 失败 | 1645/2305 | 找不到攻击目标单位: (0, 10) |
...
- 校验进度：已执行 1843 / 4868 条 APK 记录，展开项目动作 2954 个
- 终局状态：turn=19，currentPlayer=1，winner=-
- 首个问题：非法动作：当前玩家无法执行该动作
- APK 记录：event=ATTACK，source=(1,0)，move=(1,3)，target=(1,4)，recruitId=-1
- 问题位置：record=1843, turn=19, currentPlayer=1, legalActions=36
- 项目动作：`move:u_187:1,3`
- 引擎信息：非法动作：当前玩家无法执行该动作
...
- 校验进度：已执行 1645 / 2305 条 APK 记录，展开项目动作 2536 个
- 终局状态：turn=18，currentPlayer=4，winner=-
- 首个问题：找不到攻击目标单位: (0, 10)
- APK 记录：event=ATTACK，source=(0,8)，move=(0,8)，target=(0,10)，recruitId=-1
- 问题位置：record=1645, turn=18, currentPlayer=4, legalActions=20
- 项目动作：`-`
- 引擎信息：-
