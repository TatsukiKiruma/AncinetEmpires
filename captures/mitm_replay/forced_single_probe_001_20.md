...
| --- | --- | --- | ---: | --- | --- | --- |
| game_get_20260704_131018_001.bin | 0e1dd9c4c506 | 17x12, P[0,2,3,4] | 11 | 通过 | 11/11 | - |
...
- 动作：11 条，remaining=210，事件=ATTACK=2, NEXT_TURN=4, NONE=1, OCCUPY=1, STANDBY=3
- 包诊断：topFields=[g]，topRemaining=0，onlyG=true，replayEOF=false，currentStep=-1，replaySplitIndex=-1，room=PRIVATE/CLOSED
- 校验进度：已执行 11 / 11 条 APK 记录，展开项目动作 5 个
