...
- 项目动作：`move:u_267:5,2`
- 失败诊断：actor=u_267/mermaid/P0@(5,5) hp=100/100 lv=0 exp=60 range=1-2 status=none；target=-；move占位=u_374/soldier/P4@(5,2) hp=6/100 lv=0 exp=30 range=1-1 status=none；sourceTargetDist=-；moveTargetDist=-
