...
export const TERRAIN_CONFIG: Record<TerrainId, { key: string; name: string; defenseBonus: number; moveCost: number; healPerTurn: number; incomePerTurn: number; tags: string[] }> = {
  ...
  4:  { key: "hill",          name: "丘陵",       defenseBonus: 10, moveCost: 2, healPerTurn: 0,  incomePerTurn: 0,   tags: ["land", "hill"] },
  5:  { key: "island",        name: "孤岛",       defenseBonus: 10, moveCost: 3, healPerTurn: 0,  incomePerTurn: 0,   tags: ["land", "special"] },
