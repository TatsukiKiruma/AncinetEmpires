...
export const UNIT_CONFIGS: Record<UnitClass, UnitConfig> = {
  ...
  dark_mage: { key: "dark_mage", name: "黑魔法师", cost: 300, attack: 50, attackType: "magic", physicalDefense: 0, magicDefense: 20, minRange: 1, maxRange: 2, move: 4, attackGrowth: 10, defenseGrowth: 5, maxHpGrowth: 0, moveGrowth: 0, population: 1, abilities: ["blinder"], upgrade: "" },
